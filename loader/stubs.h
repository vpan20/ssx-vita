...
int pthread_getschedparam(pthread_t t,int*p,struct sched_param*s);
int pthread_getattr_np(pthread_t t,pthread_attr_t*a);
int pthread_attr_getstack(const pthread_attr_t*a,void**s,size_t*z);
int pthread_attr_setstack(pthread_attr_t*a,void*s,size_t z);
